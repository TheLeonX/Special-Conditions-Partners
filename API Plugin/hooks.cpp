...
void plugin::hookall() {
	...
	if (ActionCancelFunctionAdress > 1) {
		...
		plugin::Hook((void*)(ActionCancelFunctionAdress), condition::CancelActionFunction, 14);
	}
	...
	if (characterExpend1Adress > 1){
		...
		const std::array<std::uint8_t, 2> charBytes1{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char1Adress + 3, charBytes1);

		__int64 char2Adress = PatternScan::Scan("B9xxxxxxxxE8xxxxxxxx49xxxx45xxxxxx", characterExpend1Adress);
		//cout << char2Adress << endl;
		const std::array<std::uint8_t, 4> charBytes2{ 0x8A, 0x53, 0x01, 0x00 };
		...
		const std::array<std::uint8_t, 2> charBytes3{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char3Adress + 3, charBytes3);
	}
	...
	if (characterExpend2Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes4{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char4Adress + 2, charBytes4);
	}
	...
	if (characterExpend6Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes8{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char8Adress + 2, charBytes8);
		...
		util::memory::mem::write_bytes(char9Adress + 1, charBytes8);
		...
		util::memory::mem::write_bytes(char11Adress + 1, charBytes8);
	}
	...
	if (characterExpend4Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes6{ 0x6F, 0x0F };
	...
	if (characterExpend5Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes7{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char7Adress + 3, charBytes7);
	}
	...
	if (characterExpend3Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes5{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char5Adress + 2, charBytes5);
	}
	...
	if (characterExpend7Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes5{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char12Adress + 2, charBytes5);
	}
	...
	if (characterExpend8Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes5{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char13Adress + 2, charBytes5);
	}
	...
	if (characterExpend9Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes5{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char14Adress + 3, charBytes5);
	}
	...
	if (characterExpend10Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes5{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char15Adress + 2, charBytes5);
	}
	...
	if (characterExpend11Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes5{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char16Adress + 2, charBytes5);
	}
	...
	if (characterExpend12Adress > 1) {
		...
		const std::array<std::uint8_t, 2> charBytes5{ 0x6F, 0x0F };
		util::memory::mem::write_bytes(char17Adress + 2, charBytes5);
	}
}
